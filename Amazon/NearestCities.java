...
public class NearestCities {
    public static Comparator<? super City> Y_COMPARATOR = Comparator.comparingInt((City a) -> a.y).thenComparing(a -> a.name);
    public static Comparator<? super City> X_COMPARATOR = Comparator.comparingInt((City a) -> a.x).thenComparing(a -> a.name);
    ...
    private static String getClosestCity(City origin, List<City> neighbors) {
        ...
        return closestCity != null ? closestCity.name : "NONE";
    }
    ...
    public static void runner() {
        ...
        test(5, new String[]{"p1", "p2", "p3", "p4", "p5"}, new int[]{10, 20, 30, 40, 50},
                new int[]{10, 10, 10, 10, 10}, 5, new String[]{"p1", "p2", "p3", "p4", "p5"});
    }
